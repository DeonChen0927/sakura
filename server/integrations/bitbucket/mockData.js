...
export const MOCK_PULL_REQUESTS = [
  {
    ...
    author: { id: '{11111111-2222-3333-4444-555555555555}', name: 'Demo Author A' },
  ...
  },
  {
    ...
    author: { id: '{aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee}', name: 'Demo Author B' },
  ...
  },
  {
    ...
    author: { id: '{99999999-8888-7777-6666-555555555555}', name: 'Demo Author C' },
